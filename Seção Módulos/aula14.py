...
CAMINHO_ZIP_DIR = CAMINHO_RAIZ / 'aula_14_diretorio_zip'
CAMINHO_COMPACTADO = CAMINHO_RAIZ / 'aula14_compactado.zip'
CAMINHO_DESCOMPACTADO = CAMINHO_RAIZ / 'aula14_descompactado'
...
with ZipFile(CAMINHO_COMPACTADO, mode='w') as zip:
